...
public class SeekerLongVision : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            FindObjectOfType<GameManager>().longSpotted = false;
        }
    ...
    private void OnDrawGizmos()
    {
        ...
        if (FindObjectOfType<GameManager>().longSpotted)
        {
    ...
    //    int count = Physics.OverlapSphereNonAlloc(hider.position, radius, overlaps);
    ...
    IEnumerator waitAndCheck()
    {
        ...
        if (Scan())
        {
            FindObjectOfType<GameManager>().longSpotted = true;
            Debug.Log("true");
        }
    }
}
